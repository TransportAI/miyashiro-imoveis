  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 md:hidden w-[92%] max-w-sm pointer-events-auto">
      <motion.div
        ...
        className="bg-stone-900/95 backdrop-blur-2xl border border-stone-800 px-3 py-2.5 rounded-full shadow-2xl flex items-center justify-around text-stone-300"
      >
        {/* Home */}
        <Link href="/" className="relative flex flex-col items-center">
          ...
          <span className={`text-[9px] font-mono mt-0.5 ${isHome ? 'text-emerald-400 font-bold' : 'text-stone-400'}`}>Início</span>
        </Link>
        ...
        <Link href="/imoveis" className="relative flex flex-col items-center">
          ...
          <span className={`text-[9px] font-mono mt-0.5 ${isImoveis ? 'text-emerald-400 font-bold' : 'text-stone-400'}`}>Busca</span>
        </Link>

        {/* WhatsApp Direct - Highlighted CTA */}
        <a
          href="https://wa.me/5519993673949?text=Ol%C3%A1%2C%20Miyashiro%20Im%C3%B3veis!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20im%C3%B3veis%20em%20Amparo."
          target="_blank"
        ...
        >
          <motion.div
            ...
            className="w-11 h-11 rounded-full bg-gradient-to-tr from-[#00873E] to-[#16a34a] text-white flex items-center justify-center shadow-lg shadow-emerald-950/40 border-2 border-stone-900"
          >
            <MessageCircle className="w-5 h-5 fill-current" />
          </motion.div>
          <span className="text-[9px] font-mono font-bold text-emerald-400">Whats</span>
        </a>
        ...
        <Link href="/anunciar" className="relative flex flex-col items-center">
          ...
          <span className={`text-[9px] font-mono mt-0.5 ${isAnunciar ? 'text-emerald-400 font-bold' : 'text-stone-400'}`}>Anunciar</span>
        </Link>
        ...
        <Link href="/admin/login" className="relative flex flex-col items-center">
          ...
          <span className={`text-[9px] font-mono mt-0.5 ${isAdmin ? 'text-emerald-400 font-bold' : 'text-stone-400'}`}>Admin</span>
        </Link>
      </motion.div>
    </div>
  );
